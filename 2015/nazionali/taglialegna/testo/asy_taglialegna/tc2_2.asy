...
pen penna = gray(.5);
make_tree((0,0), 3, 4, 4, gray(.2));
make_tree((1,0), 1, 2, 6, penna);
make_tree((2,0), 4, 5, 5, penna);
make_tree((3,0), 1, 3, 3, penna);
make_tree((4,0), 2, 3, 8, penna);
make_tree((5,0), 1, 2, 8, penna);
...
label(rotate(-20) * "$\rightarrow$", (1.1,2.6), W);