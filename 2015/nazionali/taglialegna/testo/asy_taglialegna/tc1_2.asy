...
pen penna = gray(.5);
make_tree((0,0), 2, 4, 4, penna);
make_tree((1,0), 3, 5, 6, penna);
make_tree((2,0), 2, 4, 5, penna);
make_tree((3,0), 1, 2, 2, penna);
make_tree((4,0), 4, 6, 8, gray(.2));
make_tree((5,0), 2, 5, 7, penna);
make_tree((6,0), 1, 3, 3, penna);
...
label(rotate(20) * "$\leftarrow$", (3.9,3.6), W);