...
pen penna = gray(.8);
make_tree((0,0), 3, 4, 4, penna, -90);
make_tree((1,0), 1, 2, 6, penna, -90);
make_tree((2,0), 4, 5, 5, penna, -90);
make_tree((3,0), 1, 3, 3, penna, -90);
make_tree((4,0), 2, 3, 8, penna, -90);
make_tree((5,0), 1, 2, 8, penna, -90);
